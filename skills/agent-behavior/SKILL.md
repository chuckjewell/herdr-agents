...
- **Conductor loop** — **normal** lead behavior after the team exists: assign, harvest, wait, merge. Not an onboarding walk. Split: official herdr = multiplexer; this file = air traffic control (ATC); `conduct` = EMAIL/dual/Process. Humans: `docs/conductor-loop.md` (not a skill).
