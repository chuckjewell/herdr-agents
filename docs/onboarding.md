...
1. Design session: user needs vs our baselines (`workspaces.md`, Os/App examples). Back and forth on makeup until they say yes. Keep our **lead** unless they have a better concept.
...
5. Lead onboards the rest **the same two skills**. Repeat **team-onboarding** for each new workspace.

Day-to-day (swap, new occupant): **agent-behavior** pane onboard — not this skill.
